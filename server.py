...
CATEGORIES = {
    ...
    "Validated Cold Chain Box": 0.95,
    "Max Cold Chain Boxes": 0.95,
}
...
CATEGORY_ALIASES = {
    ...
    "cold chain boxes": "Validated Cold Chain Box",
    "max cold chain boxes": "Max Cold Chain Boxes",
    "max cold chain box": "Max Cold Chain Boxes",
}
...
def build_carton_template():
    ...
    ws.append(["M1", "Max Cold Chain Boxes", 50, 38, 32, 60800, 950])
